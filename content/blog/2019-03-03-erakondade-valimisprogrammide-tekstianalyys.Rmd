...
#htmlwidgets::saveWidget(verb_plot, file = "d9.html", selfcontained = TRUE)
saveWidget(ggplotly(verb_plot), file = "d9.html", selfcontained = TRUE);
```

<iframe seamless src="../d9/index.html" width="150%" height="500"></iframe>
